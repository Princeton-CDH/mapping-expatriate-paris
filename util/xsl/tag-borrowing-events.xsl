...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="borrowed-titles"
        select="document('https://raw.githubusercontent.com/Princeton-CDH/mapping-expatriate-paris/develop/borrowed-titles.xml')//row[borrowerid=$personid]"/>

    <!-- Suppress copying listPerson generated by Xinclude  -->
    <xsl:template match="tei:listPerson[@xml:id='expats']" />
    ...
    <xsl:template match="@anchored|@default|@status|@part|@instant|@org|@full"></xsl:template>
